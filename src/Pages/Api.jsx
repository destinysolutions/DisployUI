...
export const ADD_REGISTER_URL = "http://192.168.1.219/api/Register/AddRegister";
...
export const SELECT_BY_ID_USERDETAIL =
  "http://192.168.1.219/api/Register/SelectByID";
...
export const DELETE_USER = "http://192.168.1.219/api/Register/DeleteUser";
export const SCREEN_GROUP =
  "http://192.168.1.219/api/GroupScreen/AddGroupScreen";
export const SELECT_ALL_SCREENGROUP =
  "http://192.168.1.219/api/GroupScreen/SelectAll";
...
export const UPDATE_SCREEN_ASSIGN =
  "http://192.168.1.219/api/Schedule/UpdateAssignScreen";
...
export const UPDATED_SCHEDULE_DATA =
  "http://192.168.1.219/api/EventMaster/SelectAllGetSchedule";
export const ADD_TIMEZONE = "http://192.168.1.219/api/Schedule/AddTimeZone";
export const SIGNAL_R = "http://192.168.1.219/chatHub";
...
export const GET_ALL_APPS = "http://192.168.1.219/api/YoutubeApp/GetAllApps";
...
export const SELECT_BY_LIST = "http://192.168.1.219/api/Layout/SelectByList";

export const UPDATE_TRIAL_DAY =
  "http://192.168.1.219/api/Register/UpdateTrialDay";
//http://192.168.1.219
