  ...
  return (
    <div>
      <div className="rounded-xl mt-8 shadow bg-white p-5">
        <h4 className="user-name">Recent Devices</h4>
        <p>
          ...
          >
            ...
            <tbody>
              <tr className="border-b border-b-[#E4E6FF] ">
                ...
                <td>
                  <select className="bg-gray-200 border input-bor-color text-black text-sm py-3 px-2 rounded-lg w-40">
              ...
              <tr className="border-b border-b-[#E4E6FF] ">
                ...
                <td>
                  <input
                    type="text"
                    className="bg-gray-200 border input-bor-color text-black text-sm py-3 px-2 rounded-lg w-44"
        ...
        <div className="flex ">
          <div className="w-full pt-5 px-3">
            ...
            <select className="w-full bg-gray-200 border input-bor-color text-black text-xs py-3 px-4 pr-8 my-3 rounded">
