    ...
    <>
      ...
      <div className="pt-6 px-5 page-contain">
        <div className={`${sidebarOpen ? "ml-60" : "ml-0"}`}>
          ...
          <div className="rounded-xl mt-8 shadow bg-white mt-3">
            <h4 class="text-xl font-bold p-5">Profile Details</h4>
            <div class="flex items-center border-b border-b-[#E4E6FF] p-5">
              <div class="layout-img me-5">
                <img src={file} alt="Logo" class="w-32 rounded-lg" />
              </div>
              <div class="layout-detaills">
                <div class="flex">
                  <lable >
                    <button class="px-5 bg-primary text-white rounded-full py-2 border border-primary me-3" onClick={handleClick}>Upload new photo</button>
                    <input
                      type="file"
                      id="upload-button"
                      style={{ display: "none" }}
                ...
                <p class="text-lg block mt-3">Display content from your connected accounts on your site </p>
              </div>
            </div>
              ...
              <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
                <div class="-mx-3 md:flex mb-6">
                  <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    <label class="label_top text-xs" for="company">
                      First Name*
                    </label>
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="company" type="text" placeholder="Harry" />
                    <div>
                    </div>
                  </div>
                  <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="company" type="text" placeholder="McCall" />
                    <div>
                    </div>
                  </div>
                  <div class="md:w-1/2 px-3">
                    <label class="label_top text-xs" for="title">
                      Email*
                    </label>
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="title" type="email" placeholder="harrymc.call@gmail.com" />
                  </div>

                </div>
                <div class="-mx-3 md:flex mb-6">
                  <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    <label class="label_top text-xs" for="application-link">
                      Phone Number*
                    </label>
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="application-link" type="text" placeholder="(397) 294-5153" />
                  </div>
                  <div class="md:w-1/2 px-3">
                    <label class="label_top text-xs" for="application-link"> Address* </label>
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="application-link" type="text" placeholder="132, My Street, Kingston, New York 12401." />
                  </div>
                  <div class="md:w-1/2 px-3">
                    <label class="label_top text-xs" for="title">
                      Organization*
                    </label>
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="title" type="text" placeholder="Manager" />
                  </div>

                </div>
                <div class="-mx-3 md:flex mb-2">
                  <div class="md:w-1/2 px-3">
                    <label class="label_top text-xs" for="location">
                      Zip Code*
                    </label>
                    <input class="w-full bg-gray-200 text-black border input-bor-color rounded-lg py-3 px-4 mb-3" id="application-link" type="text" placeholder="10001" />
                  </div>
                  <div class="md:w-1/2 px-3">
                    <label class="label_top text-xs" for="job-type">
                      Country*
                    </label>
                    <div>
                  ...
                  <div class="md:w-1/2 px-3">
                    ...
                    <div>
                      <select class="w-full bg-gray-200 border input-bor-color text-black text-xs py-3 px-4 pr-8 mb-3 rounded" id="location">
                        <option>Abuja</option>
                        <option>Enugu</option>
                        <option>Lagos</option>
                      </select>
                ...
                <div class="-mx-3 md:flex mb-2">
                  <div class="md:w-1/2 px-3">
                    <label class="label_top text-xs" for="department">
                      Language*
                    </label>
                    <div>
          ...
          <div className="rounded-xl mt-8 shadow bg-white mt-3 p-5">
            <h4 class="text-xl font-bold ">Delete Account</h4>
            <div class="flex items-start space-x-3 py-6">
              <input type="checkbox" class="border-gray-300 rounded h-5 w-5" />
              <div class="flex flex-col">
                <h1 class="text-gray-700 font-medium leading-none">I confirm my account deactivation</h1>
              </div>
            </div>
            <button class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"> Deactivate Account</button>
