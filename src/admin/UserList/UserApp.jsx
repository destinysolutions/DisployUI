          ...
          <>
            ...
            <div className=" bg-white rounded-xl mt-5 shadow screen-section">
                ...
                >
                  ...
                  <tbody>
                    {allAppsData?.length > 0 &&
                      sortedAndPaginatedData.map((instance, index) => (
                        <tr
                          className={`border-b border-[#eee] text-center cursor-pointer`}
                          key={index}
                        >
              ...
              <div className="flex items-center">
                <span className="text-gray-500">{`Total ${allAppsData?.length} Apps`}</span>
              </div>
              <div className="flex justify-end">
                ...
                <button
                  onClick={() => handlePageChange(currentPage + 1)}
                  disabled={(currentPage === totalPages) || (allAppsData?.length === 0)}
