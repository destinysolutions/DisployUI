          ...
          <div className={`${sidebarOpen ? "ml-60" : "ml-0"}`}>
            <div className="lg:flex lg:justify-between sm:block  items-center">
              ...
              <div className="flex md:mt-5 lg:mt-0 sm:flex-wrap md:flex-nowrap xs:flex-wrap youtubebtnpopup">
                ...
                <button className="sm:ml-2 xs:ml-1 flex align-middle border-primary items-center border-2 rounded-full px-[10px] text-xl  hover:bg-primary hover:text-white hover:bg-primary-500 hover:shadow-lg hover:shadow-primary-500/50" onClick={hideVideoPreview}>
                  <AiOutlineClose />
                </button>
              </div>
            </div>
                    ...
                    >
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <input type="text" placeholder="e.g. https://youtu.be/dQw4w9WgXcQ" onChange={handleYoutubeChange}/>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" placeholder="e.g.10" value={maxVideos}
