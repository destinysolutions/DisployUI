                        ...
                        <div className=" grid grid-cols-12 gap-4 mt-5">
                          ...
                          {instanceView && (
                            <div className="bg-black bg-opacity-50 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                              <div
                                ref={modalRef}
                                className="w-[980px] my-6 mx-auto lg:max-w-4xl md:max-w-xl sm:max-w-sm xs:max-w-xs"
                              >
                                <div className="w-[980px] border-0 rounded-lg shadow-lg relative flex flex-col bg-white outline-none focus:outline-none">
