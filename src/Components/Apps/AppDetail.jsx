                          ...
                          <div className="relative">
                            <button className="float-right p-2">
                              <input
                                className="h-5 w-5"
                                type="checkbox"
                                checked={instanceCheckboxes[item.youtubeId]}
                                onChange={() => {
                                  handleCheckboxClick(item.youtubeId);
                                  handleCheckboxChange(item.youtubeId);
                                }}
                              />
                            </button>
                            {appCheckbox === item.youtubeId &&
                              appDetailModal && (
                                <>
                                      ...
                                      <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none md:max-w-xl sm:max-w-sm xs:max-w-xs">
                                        ...
                                        <div className="p-2">
                                          <ReactPlayer
                                            ...
                                            muted={item.muteVideos}
                                            controls={item.toggleSubtitles}
                                          />
                                        </div>
