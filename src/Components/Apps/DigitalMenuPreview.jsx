        ...
        <>
            <div className="mt-6">
                <div className="grid grid-cols-12 gap-4 h-full">
                    <div className={`lg:col-span-12 md:col-span-12 sm:col-span-12 xs:col-span-12 shadow-md rounded-lg items-center`} style={{ backgroundColor: selectedColor, backgroundImage: theme?.posThemePath ? `url(${theme.posThemePath})` : "none" }}>
                        <Swiper
                            spaceBetween={30}
                            centeredSlides={true}
                            autoplay={{
                                ...
                                return (
                                    <div>
                                        {category?.allItem?.map((cate) => {
                                            return (
                                                <>
                                                    <SwiperSlide className='p-5 rounded-lg' style={{ backgroundColor: selectedColor, backgroundImage: theme?.posThemePath ? `url(${theme.posThemePath})` : "none" }}>
