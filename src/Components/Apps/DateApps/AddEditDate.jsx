...
const AddEditDate = ({ sidebarOpen, setSidebarOpen }) => {
    ...
    const [instanceName, setInstanceName] = useState(moment().format("YYYY-MM-DD hh:mm A"));
                ...
                <div className={`${sidebarOpen ? "ml-60" : "ml-0"}`}>
                    <div className="px-6 page-contain">
                        <div>
                            ...
                            {showPreview === true ? (
                                <div className="w-[85%] h-[35rem] bg-gray-50 rounded-sm shadow-md border-4 border-black bg-sky-100 flex items-center justify-center overscroll-none m-auto mt-5">
                                    <div className="flex items-center  h-[53%]  bg-white shadow-lg  w-[50%]  ">
                                        ...
                                        <div className="flex items-center justify-center h-[22rem] bg-red w-[250px]  ml-8">
                                ...
                                <div className="flex flex-col lg:flex-row  rounded-lg h-full gap-1">
