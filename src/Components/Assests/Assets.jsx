...
const Assets = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const fetchData = () => {
    axios
      .get("https://disployapi.thedestinysolutions.com/api/Video/GetAll")
      .then((response) => {
                ...
                {gridData.length > 0 ? (
                  gridData.map((item, index) => (
                    <li key={`tabitem-grid-${item.id}-${index}`} className="relative list-none assetsbox">
                      ...
                      {item.video && (
                        <video controls className="w-full rounded-2xl relative h-56">
                      ...
                      >
                        {item.image && <RiGalleryFill className='bg-primary text-white text-3xl p-3 rounded-full  xs:min-w-[50px]  xs:min-h-[50px] sm:min-w-[60px]  sm:min-h-[60px] md:min-w-[50px] md:min-h-[50px]  lg:min-w-[60px]  lg:min-h-[60px] border-4 border-white border-solid shadow-primary hover:bg-SlateBlue cursor-pointer ' />}
                        {item.video && <HiOutlineVideoCamera className='bg-primary text-white text-3xl p-3 rounded-full  xs:min-w-[50px]  xs:min-h-[50px] sm:min-w-[60px]  sm:min-h-[60px] md:min-w-[50px] md:min-h-[50px]  lg:min-w-[60px]  lg:min-h-[60px] border-4 border-white border-solid shadow-primary hover:bg-SlateBlue cursor-pointer ' />}
                      </div>
                        ...
                        <div className="vdetails">
                          <div className="flex justify-end">
                            ...
                            <div className="storage mb-1">
                              <span className="bg-white text-primary rounded-sm p-1 text-sm">{item.fileSize}</span>
                            </div>
                          </div>
                  ...
                  <tbody>
                    ...
                    {tableData.length > 0 ? (
                      tableData.map((item, index) => (
                        <tr key={`tabitem-table-${item.id}-${index}`} className=" mt-2 bg-white rounded-lg  font-normal text-[14px] text-[#5E5E5E] shadow-sm border-b border-[#cccccca6]">                        <>
                            ...
                            {item.image &&
                              <div className="imagebox">
                                ...
                                <div className="tabicon text-center absolute left-10 top-3">
                                  ...
                                  {item.image && <RiGalleryFill className="bg-primary text-white p-2 text-3xl rounded-full shadow-lg" />}
                                </div>
                              </div>
                            }
                            ...
                            {item.video &&
                              <div className="relative videobox">
                                ...
                                <div className="tabicon text-center absolute left-10 top-3">
                                  ...
                                  {item.video && <HiOutlineVideoCamera className="bg-primary text-white p-2 text-3xl rounded-full shadow-lg" />}
                                </div>
                              </div>
                            }
