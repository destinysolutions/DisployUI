...
const Assets = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const [asstab, setAsstab] = useState(1);
  ...
  const handleFolderDeleteAll = async () => {
    try {
                  ...
                  <div className="flex items-center justify-center">
                    <ul className="flex items-center xs:mr-1 mr-3 rounded-full border-2 border-SlateBlue">
                      <li className="flex items-center ">
                        <button
                          className={asstab === 1 ? "tabshow tabassactive " : "asstab "}
                          onClick={() => setAsstab(1)}
                        >
                ...
                <div className="tabs lg:mt-5 md:mt-5  sm:mt-5 xs:mt-0">
                  ...
                  {asstab === 2 &&
                    <GridAssets
                      ...
                      setFolderDisable={setFolderDisable}
                      ...
                      setScreenAssetID={setScreenAssetID}
