...
import { filterScreensDistance, greenOptions, IncludeExclude, kilometersToMeters, } from '../../../Common/Common';
        ...
        <div className="w-full h-full p-5 flex items-center justify-center  ">
            <div className="lg:w-[900px] md:w-[700px] w-full h-[70vh] bg-white lg:p-6 p-3 rounded-lg shadow-lg   ">
                <div className="flex flex-row items-center gap-2">
                    <h2 className="text-xl font-semibold">Find Your Screen</h2>
                </div>
                                        ...
                                        <div>
                                            <RiDeleteBinLine
                                                ...
                                                onClick={() => {
                                                    ...
                                                    console.log('Filtered Screens: ', matchingScreens);
                        ...
                        <div className="h-full w-full flex items-end">
                            <div className='w-full'>
                                <div className="flex items-center justify-between  w-full">
                                    ...
                                    <label for='Yes' className=" lg:text-sm md:text-sm sm:text-xs xs:text-xs">{totalDuration}</label>
                                </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <label for='Yes' className=" lg:text-sm md:text-sm sm:text-xs xs:text-xs">${totalPrice}</label>
                                </div>
                            </div>
