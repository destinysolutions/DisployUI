...
export default function BookSlotTimeZone({ allTimeZone, selectedTimeZone, handleSelectTimeZoneChange, repeat,
    startDate, handleStartDateChange, endDate, setRepeat, handleEndDateChange, getallTime, handleStartTimeChange, handleEndTimeChange,
    handleSequenceChange, handleaftereventChange, handleAftereventTypeChange, handleOpenImagePopup, handleAddItem, handleRemoveItem, selectAllDays, handleCheckboxChange, countAllDaysInRange,
    handleDayButtonClick, setPage, handleBookSlot, page, selectedDays
}) {
    return (
        <div>
                                                ...
                                                >
                                                    ...
                                                    <div className="relative  col-span-4 flex justify-center items-center gap-4">
                                                        ...
                                                        <div className="flex items-center justify-center gap-2">
                                                            {(item?.horizontalFileName || item?.verticalFileName) &&
                                                                <p className="w-20 truncate"> {item?.horizontalFileName || item?.verticalFileName}</p>
                                                            }
