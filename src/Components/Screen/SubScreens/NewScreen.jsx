        ...
        <div className={`${sidebarOpen ? (sidebarOverlap ? "ml-60" : "") : "ml-2"}`}>
          <div className="justify-between flex items-center">
            <div className="section-title">
              <h1 className="not-italic font-medium text-2xl text-[#001737]">Merged Screens</h1>
            </div>
            <div className="icons flex  items-center">
              ...
              <div className="px-1">
                <button className="border rounded-full ">
                  <img src="/ScreenImg/connect_screen.svg" className="w-[30px] h-[28px] p-1" />
                </button>
              </div>
              <div className="px-2">
              ...
              <div className="flex items-center">
                {isHovering && (
                  <div className="flex items-center">
                    ...
                    <button className="rounded-full mx-1 border hover:bg-red hover:border-red"><RiDeleteBin5Line className="text-2xl p-1 hover:text-white" /></button>
                    <button> <input type="checkbox" className=" mx-1 w-6 h-5 mt-2" /></button>
                  </div>
                )}

                <div className=" flex items-center" >
                  {showdata && !isHovering && <> <button className="bg-[#E4E6FF] py-2 px-2 text-sm rounded-md mr-2 hover:bg-primary hover:text-white">Preview</button> <button className="rounded-full mx-1 border hover:bg-SlateBlue"><TbUpload className="text-2xl p-1 hover:text-white" /></button><button className="rounded-full mx-1 border hover:bg-red hover:border-red"><RiDeleteBin5Line className="text-2xl p-1 hover:text-white" /></button><button> <input type="checkbox" className=" mx-1 w-6 h-5 mt-2" /></button></>}
                  <button className="showicon" onClick={() => setShowdata(!showdata)} onMouseOver={handleMouseOver}
                    onMouseOut={handleMouseOut}> {showdata ? <IoIosArrowDropup className="text-3xl" /> : <IoIosArrowDropdown className="text-3xl" />}</button>
                </div>
          ...
          <div className="accordions mt-5">
            <div className="section shadow-md p-5 rounded-md bg-white flex items-center justify-between">
              ...
              <div className="flex items-center">
                ...
                <div className=" flex items-center" >
                  {showdata2 && !isHovering2 && <> <button className="bg-[#E4E6FF] py-2 px-2 text-sm rounded-md mr-2 hover:bg-primary hover:text-white">Preview</button> <button className="rounded-full mx-1 border hover:bg-SlateBlue"><TbUpload className="text-2xl p-1 hover:text-white" /></button><button className="rounded-full mx-1 border hover:bg-red hover:border-red"><RiDeleteBin5Line className="text-2xl p-1 hover:text-white" /></button><button> <input type="checkbox" className=" mx-1 w-6 h-5 mt-2" /></button></>}
                  <button className="showicon" onClick={() => setShowdata2(!showdata2)} onMouseOver={handleMouseOver2}
                    onMouseOut={handleMouseOut2}> {showdata2 ? <IoIosArrowDropup className="text-3xl" /> : <IoIosArrowDropdown className="text-3xl" />}</button>
                </div>
            ...
            {showdata2 && <div className="screen-table overflow-x-auto">
              <table className="mt-9 w-full sm:mt-3">
                <thead>
                  <tr className="flex justify-between items-center">
                    <th className="p-3 font-medium text-[14px]">
