  ...
  return (
    <>
      <div className="flex border-b border-gray py-3 ">
        <Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} sidebarOverlap={sidebarOverlap} />
        <Navbar />
      </div>
        ...
        <div className={`${sidebarOpen ? (sidebarOverlap ? "ml-60" : "") : "ml-2"}`}>
          <div className="justify-between flex items-center">
            <div className="section-title">
              <h1 className="not-italic font-medium text-2xl text-[#001737]">Group Name</h1>
            </div>
            <div className="icons flex  items-center">
              ...
              <div className="px-1">
                <button className="border rounded-full ">
                  <img src="/ScreenImg/groupicon.png" className="w-[30px] px-[6px] py-[3px]" />
                </button>
              </div>
              <div className="px-2">
                <button > <input type="checkbox" className=" w-6 h-6" /></button>
              </div>
          ...
          <div className="accordions mt-5">
            <div className="section shadow-md p-5 rounded-md bg-white flex items-center justify-between">
              ...
              <div className="flex items-center">
                {isHovering && (
                  <div className="flex items-center">
                    <button className="bg-[#E4E6FF] py-2 px-2 text-sm rounded-md mr-2 hover:bg-primary hover:text-white flex items-center"><LuMonitor className="text-sm mr-1" />03</button>
                    <button className="rounded-full mx-1 border hover:bg-SlateBlue"><TbUpload className="text-2xl p-1 hover:text-white" /></button>
                    <button className="rounded-full mx-1 border hover:bg-SlateBlue"><TbArrowBarRight className="text-2xl p-1 hover:text-white" /></button>
                    <button className="rounded-full mx-1 border hover:bg-red hover:border-red"><RiDeleteBin5Line className="text-2xl p-1 hover:text-white" /></button><button> <input type="checkbox" className=" mx-1 w-6 h-5 mt-2" /></button>
                  </div>
                )}


                <div className=" flex items-center">
                  {showdata && !isHovering && <> <button className="bg-[#E4E6FF] py-2 px-2 text-sm rounded-md mr-2 hover:bg-primary hover:text-white flex items-center"><LuMonitor className="text-sm mr-1" />03</button>
                    <button className="rounded-full mx-1 border hover:bg-SlateBlue"><TbUpload className="text-2xl p-1 hover:text-white" /></button>
                    <button className="rounded-full mx-1 border hover:bg-SlateBlue"><TbArrowBarRight className="text-2xl p-1 hover:text-white" /></button>
                    <button className="rounded-full mx-1 border hover:bg-red hover:border-red"><RiDeleteBin5Line className="text-2xl p-1 hover:text-white" /></button><button> <input type="checkbox" className=" mx-1 w-6 h-5 mt-2" /></button></>}
                  <button onClick={() => setShowdata(!showdata)} onMouseOver={handleMouseOver}
                    onMouseOut={handleMouseOut}> {showdata ? <IoIosArrowDropup className="text-3xl" /> : <IoIosArrowDropdown className="text-3xl" />}</button></div>
              </div>
            </div>

            {showdata && <div className="screen-table overflow-x-auto">
                ...
                <tbody>
                  <tr className=" mt-7 bg-white rounded-lg  font-normal text-[14px] text-[#5E5E5E] border border-gray shadow-sm  flex justify-between items-center px-5 py-2">
                    <td className="flex items-center ">
                      <input type="checkbox" className="mr-3" /> My Screen 1 <button><MdOutlineModeEdit className="text-sm ml-2 hover:text-primary" /></button>
                    </td>
                    <td className="p-2">
                  ...
                  <tr className=" mt-7 bg-white rounded-lg  font-normal text-[14px] text-[#5E5E5E] border border-gray shadow-sm flex  justify-between items-center px-5 py-2">
                    <td className="flex items-center">
                      <input type="checkbox" className=" mr-3" /> My Screen 2 <button><MdOutlineModeEdit className="text-sm ml-2 hover:text-primary" /></button>
                    </td>
                    <td className="p-2">
                      <button className="bg-[#3AB700] rounded-full px-6 py-1 text-white hover:bg-primary">
                        Live
                  ...
                  <tr className=" mt-7 bg-white rounded-lg  font-normal text-[14px] text-[#5E5E5E] border border-gray shadow-sm flex  justify-between items-center px-5 py-2">
                    <td className="flex items-center">
                      <input type="checkbox" className=" mr-3" /> My Screen 3 <button><MdOutlineModeEdit className="text-sm ml-2 hover:text-primary" /></button>
                    </td>
                    <td className="p-2">
                      <button className="bg-[#3AB700] rounded-full px-6 py-1 text-white hover:bg-primary">
                        Live
