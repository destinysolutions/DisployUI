           ...
           <div className="justify-between flex items-center">
            ...
            <div className="accordions mt-5"> 
                <div className="section shadow-md p-5 rounded-md bg-white flex items-center justify-between">
                   ...
                   { showdata && <> <button className="bg-[#E4E6FF] py-2 px-2 text-sm rounded-md mr-2 hover:bg-primary hover:text-white flex items-center"><LuMonitor className="text-sm mr-1"/>03</button>
                    ...
                    <button onClick={() => setShowdata(!showdata)}> { showdata ? <IoIosArrowDropup className="text-3xl"/> : <IoIosArrowDropdown className="text-3xl"/>}</button></div>
                    </div>
                ...
                <table className="mt-9 w-full sm:mt-3">
                  ...
                  <tbody>
                    ...
                    <tr className=" mt-7 bg-white rounded-lg  font-normal text-[14px] text-[#5E5E5E] border border-gray shadow-sm flex  justify-between items-center px-5 py-2">
                      <td className="flex items-center">
                        <input type="checkbox" className=" mr-3" /> My Screen 2 <MdOutlineModeEditOutline className=" ml-2 text-xs"/>
                      </td>
                      <td className="p-2">
                        <button className="bg-[#3AB700] rounded-full px-6 py-1 text-white hover:bg-primary">
                          Live
                    ...
                    <tr className=" mt-7 bg-white rounded-lg  font-normal text-[14px] text-[#5E5E5E] border border-gray shadow-sm flex  justify-between items-center px-5 py-2">
                      <td className="flex items-center">
                        <input type="checkbox" className=" mr-3" /> My Screen 3 <MdOutlineModeEditOutline className=" ml-2 text-xs"/>
                      </td>
                      <td className="p-2">
                        <button className="bg-[#3AB700] rounded-full px-6 py-1 text-white hover:bg-primary">
                          Live
