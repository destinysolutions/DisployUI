...
const Screens = () => {
  ...
  const handleCSTooltipToggle = () => {
    setConnectScreenTooltipVisible(!connectScreenTooltipVisible);
  };
  const handleNSTooltipToggle = () => {
    setNewScreenTooltipVisible(!newScreenTooltipVisible);
  };
  const handleSGTooltipToggle = () => {
    setScreenGroupTooltipVisible(!screenGroupTooltipVisible);
  };
  const handleSATooltipToggle = () => {
    setselectAllTooltipVisible(!selectAllTooltipVisible);
  };
