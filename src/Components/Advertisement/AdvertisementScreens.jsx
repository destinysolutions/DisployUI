                                    ...
                                    <div className="lg:col-span-2 lg:flex items-center md:mt-0 lg:mt-0 md:justify-end sm:mt-3 flex-wrap">
                                        ...
                                        {active === 0 && (
                                            <button
                                                ...
                                                onClick={() => { setactive(1); setSearchScreen(""); setPageSize(5); }}
                                            >
                                                                        ...
                                                                        {active === 0 ? (
                                                                            ...
                                                                            >
                                                                                <div
                                                                                    ...
                                                                                    className="flex items-center justify-between gap-2 border-gray bg-lightgray border rounded-full py-2 px-3 lg:text-sm md:text-sm sm:text-xs xs:text-xs mx-auto"
                                                                                >
