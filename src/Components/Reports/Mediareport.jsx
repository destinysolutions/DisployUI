...
const Mediareport = ({ allReportData, debouncedOnChange, exportDataToCSV, loading, sidebarOpen }) => {
  return (
    <>
              ...
              <thead>
                <tr className="bg-lightgray rounded-md">
                  <th className="flex items-center font-medium p-3">
                    Screen Name <CiFilter className="text-sm text-primary ml-2" />
                  </th>
                  <th className=" font-medium text-center p-3">Google Location</th>
                  <th className=" font-medium text-center p-3">Assets Name</th>
                  <th className=" font-medium text-center p-3">Streaming Hours</th>
