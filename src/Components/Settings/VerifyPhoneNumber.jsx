...
const VerifyPhoneNumber = ({ toggleModal, otpValues, handleOtpChange, otpRefs, verifyOTP, errorMessge }) => {
    return (
        <>
            <div
                id="default-modal"
            ...
            >
                <div className="relative p-4 w-full max-w-3xl max-h-full">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        {/* Modal header */}
                        <div className="flex items-center justify-between p-3 md:p-4 rounded-t border-b dark:border-gray-600">
