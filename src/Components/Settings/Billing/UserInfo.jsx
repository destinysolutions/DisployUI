          ...
          <div className="bg-white shadow-xl rounded-xl p-5 border border-gray-200 min-h-full m-1">
            ...
            <div className="user-pro-details">
              ...
              <div className="flex justify-center w-full mt-2">
                <button className="mr-3 hover:bg-white hover:text-blue text-base px-8 py-2 border border-blue  shadow-md rounded-full bg-blue text-white ">
                  Edit
                </button>
                <button className="hover:bg-white hover:text-red-900 text-base px-8 py-2 border border-red-900 shadow-md rounded-full text-red-900  bg-red-200 ">
                  {" "}
                  Suspend
                </button>
              </div>
        ...
        <div className="w-full lg:w-1/2 px-3 mb-4 ">
          <div className="bg-white shadow-xl rounded-xl p-5 border border-gray-200 min-h-full">
            <div className="user-pro-details">
              ...
              <strong className="">Your Current Plan 14-day FREE trial</strong>
              <p className="mb-4">A simple start for everyone</p>
              <strong className="">Active until July 25, 2023</strong>
              <p className="mb-4">
              ...
              <div className="flex justify-center w-full mb-5">
                ...
                <button className="hover:bg-white hover:text-text-red-900 text-base px-8 py-2 border border-red-900 shadow-md rounded-full text-red-900  bg-red-200 ">
                  {" "}
                  Cancel Subscription
                </button>
              </div>
