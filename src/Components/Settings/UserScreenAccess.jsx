...
const UserScreenAccess = ({
    screenAccessModalRef,
    setScreenAccessModal,
    loading,
    userScreenData,
    sidebarOpen
}) => {
    ...
    const totalPages = Math.ceil(userScreenData?.length / itemsPerPage);
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        <div className="schedual-table bg-white mt-8 shadow p-3 w-full overflow-x-scroll sc-scrollbar rounded-lg">
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    ) : !loading && userScreenData?.length > 0 && sortedAndPaginatedData?.length > 0 ? (
                        ...
                        <div className="flex lg:flex-row lg:justify-between md:flex-row md:justify-between sm:flex-row sm:justify-between flex-col justify-end p-5 gap-3">
                            <div className="flex items-center">
                                <span className="text-gray-500">{`Total ${userScreenData?.length} Screens`}</span>
                            </div>
                            <div className="flex justify-end">
                                ...
                                <button
                                    onClick={() => handlePageChange(currentPage + 1)}
                                    disabled={(currentPage === totalPages) || (userScreenData?.length === 0)}
...
export default UserScreenAccess
