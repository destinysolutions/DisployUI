  ...
  return (
    <>
      <div className="lg:p-5 md:p-5 sm:p-2 xs:p-2">
        <div>
          <h1 className="text-base text-primary font-medium mb-5">
            Billing information
          </h1>
        </div>
        <div className="payment-method bg-[#EFF3FF] lg:p-5 md:p-5 sm:p-2 xs:p-2 rounded-lg">
          ...
          <div className="grid grid-cols-6 gap-4 mt-5">
            <div className="lg:col-start-2 md:col-start-1 sm:col-start-1 lg:col-span-4 md:col-span-6 sm:col-span-6 bg-white rounded-xl shadow-sm lg:p-5 md:p-5 sm:p-2 xs:p-2">
                ...
                <li className="paymentbox border border-[#D5E3FF] rounded-lg p-3 mb-3">
                  <div className="flex items-center justify-between">
                    <div className="lg:flex md:flex sm:flex xs:block items-center">
                      <img
                        src="../../../Settings/logos_mastercard.png"
                        className="mr-2"
                      />
                      <h4 className="text-[#606060] lg:text-sm md:text-sm sm:text-sm xs:text-xs">
                        Axis Bank
                      </h4>
                      <h4 className="text-[#606060] lg:text-sm md:text-sm sm:text-sm xs:text-xs">
                        **** **** **** 8395
                ...
                <li className="paymentbox border border-[#D5E3FF] rounded-lg p-3 mb-3">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      >
                        <AiOutlinePlus className=" text-SlateBlue bg-lightgray rounded-md text-2xl p-1 mr-2" />
                        <h4 className="text-[#606060] lg:text-sm md:text-sm sm:text-sm xs:text-xs">
                          Add New Card
                        </h4>
                      </button>
          ...
          {Addnewcard && (
            <div className="grid grid-cols-6 gap-4 mt-5 addnewcard">
              <div className="lg:col-start-2 md:col-start-1 sm:col-start-1 lg:col-span-4 md:col-span-6 sm:col-span-6 bg-white rounded-xl shadow-sm lg:p-5 md:p-5 sm:p-2 xs:p-2">
                ...
                <div className="grid grid-cols-12 lg:gap-6 md:gap-6 sm:gap-3 xs:gap-4 mt-6">
                  ...
                  <div className="col-span-12 text-center">
                    <button className="hover:bg-white hover:text-primary lg:text-base md:text-base sm:text-sm xs:text-xs xs:text-sm xs:text-xs lg:px-8 md:px-8 sm:px-6 xs:px-3 lg:py-3 md: md:py-3 sm:py-2  xs:py-2 border border-primary  shadow-md rounded-full bg-primary text-white ">
                ...
                <li className="paymentbox border border-[#D5E3FF] rounded-lg p-3 mb-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-[#606060] text-sm xs:text-xs">
                        Google Pay
                      </span>
                    </div>
